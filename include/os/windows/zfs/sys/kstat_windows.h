...
/* Most vdev_queue vars are static in upstream — stubs in zfs_kstat_windows.c */
...
/* zfs_delay_max_ns, zfetch_max_streams, zfetch_min_sec_reap, metaslab_aliquot,
 * zfs_vdev_cache_max, spa_max_replication_override, zfs_no_scrub_io/prefetch,
 * zfs_immediate_write_sz, zvol_immediate_write_sz: static in upstream modules */
...
/* zfs_free_bpobj_enabled, zfs_send_corrupt_data, zfs_send_queue_length,
 * zfs_recv_queue_length, zfs_send_set_freerecords_bit,
 * send_holes_without_birth_time, dbuf_cache_max_bytes: static in upstream */
...
/* zfs_trim_*, zfs_send_unmodified_spill_blocks, zfs_special_class_*,
 * zfs_initialize_value, zfs_autoimport_disable, cpu_avx_supported:
 * static in upstream modules — stubs in zfs_kstat_windows.c */
...
/* spl_kstat_registry removed upstream */
