...
/* DataCore: performance metrics IOCTLs */
...
/* DataCore: dirlist, security, xattr helpers */
...
/* xattr_protected, xattr_stream, zfs_getwinflags, zfs_setunlink, zfs_find_dvp_vp declared above with updated 2.4.1 signatures */
